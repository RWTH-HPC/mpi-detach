...
DLL_PUBLIC int MPIX_Start_detached(MPI_Request *request, MPIX_Detach_callback *callback,
                void *data);

DLL_PUBLIC int MPIX_Start_detached_status(MPI_Request *request,
                       MPIX_Detach_callback_status *callback, void *data);

DLL_PUBLIC int MPIX_Start_detached_each(int count, MPI_Request array_of_requests[],
                     MPIX_Detach_callback *callback, void *array_of_data[]);

DLL_PUBLIC int MPIX_Start_detached_each_status(int count, MPI_Request array_of_requests[],
                            MPIX_Detach_callback_status *callback,
                            void *array_of_data[]);

DLL_PUBLIC int MPIX_Start_detached_all(int count, MPI_Request array_of_requests[],
                    MPIX_Detach_callback *callback, void *data);

DLL_PUBLIC int MPIX_Start_detached_all_status(int count, MPI_Request array_of_requests[],
                           MPIX_Detach_all_callback_statuses *callback,
                           void *data);
